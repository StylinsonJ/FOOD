...
class UserList extends Component {
    ...
    lastPage = () => {
        let userLength = this.props.userData.users.length;
        if(this.state.currentPage < Math.ceil(userLength / this.state.usersPerPage)) {
            this.setState({
                currentPage: Math.ceil(userLength / this.state.usersPerPage)
            });
        }
    };
